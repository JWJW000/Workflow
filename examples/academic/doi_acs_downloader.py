#!/usr/bin/env python3
"""Download ACS OA and subscription PDFs through BUAA WebVPN."""
...
if __name__ == "__main__":
    ...
    add_default("--acs-webvpn")
    add_default("--state-prefix", "acs_buaa_webvpn")
    ...
    add_default("--workflow", "examples/templates/doi-acs-browser-downloader.yaml")
    main()
